...
namespace Pixel
{
	...
	namespace Internal
	{
		...
		template <class To, int num, int shift, int bits, int r_shift>
		struct upshift
		{
		...
		template <class To, int shift, int bits, int r_shift>
		...
		template <class To, class From, int i = int_info<To, From>::shift_dir>
	...
	inline To scalar_convert(const D& d) { return Internal::ScalarConvert<From, To, D>::from(d); }
