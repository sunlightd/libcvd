...
class CVD::FITS::ReadPimpl
{
	...
	template <class C>
	void convert_raw_pixel_line(unsigned char*, C* data);
	template <template <class> class C>
	void convert_raw_pixel_line(unsigned char*, C<unsigned short>* data);
...
template <class T>
void ReadPimpl::convert_raw_pixel_line(unsigned char* rowp, T* d)
{
	copy(rowp, rowp + my_size.x * bytes_per_pixel, (unsigned char*)(d));
}

template <template <class> class T>
void ReadPimpl::convert_raw_pixel_line(unsigned char* rowp, T<unsigned short>* d)
{
